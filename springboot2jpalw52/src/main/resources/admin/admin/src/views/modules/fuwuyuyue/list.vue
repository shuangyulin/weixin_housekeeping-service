<template>
	<div class="main-content" :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('fuwuyuyue','订单提醒')" @click="dingdantixingCrossAddOrUpdateHandler(scope.row,'cross','否','是','','')" type="success">
		...
		<dingdantixing-cross-add-or-update v-if="dingdantixingCrossAddOrUpdateFlag" :parent="this" ref="dingdantixingCrossaddOrUpdate"></dingdantixing-cross-add-or-update>
...
import dingdantixingCrossAddOrUpdate from "../dingdantixing/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				dingdantixingCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			dingdantixingCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				...
				this.dingdantixingCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.dingdantixingCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.dingdantixingCrossaddOrUpdate.init(row.id,type);
				});
			},
			payHandler(row){
