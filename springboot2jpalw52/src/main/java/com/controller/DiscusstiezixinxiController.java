...
public class DiscusstiezixinxiController {
    ...
    public R security(@RequestParam String username){
        DiscusstiezixinxiEntity discusstiezixinxi = discusstiezixinxiService.selectOne(new EntityWrapper<DiscusstiezixinxiEntity>().eq("", username));
        return R.ok().put("data", discusstiezixinxi);
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscusstiezixinxiEntity discusstiezixinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscusstiezixinxiEntity> ew = new EntityWrapper<DiscusstiezixinxiEntity>();
